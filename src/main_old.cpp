...
// ============== GLOBAL STATE (Robot position tracking) ==============
...
void catapultControl() {
  ...
  while (true) {
    ...
    bool middleGoal = controller.get_digital(pros::E_CONTROLLER_DIGITAL_R2);
    bool longGoal = controller.get_digital(pros::E_CONTROLLER_DIGITAL_L1);
